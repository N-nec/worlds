...
local YMIN = worlds.settings.redsky_asteroids.YMIN or 6000
local YMAX = worlds.settings.redsky_asteroids.YMAX or 7000


-- Register on_generated function for this layer
minetest.register_on_generated(
		worlds.asteroids.create_on_generated(YMIN, YMAX, {
